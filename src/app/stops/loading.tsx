    ...
    >
      <div className="flex flex-1 flex-col gap-2">
        ...
        <div className="flex max-w-full flex-row flex-wrap gap-1">
          ...
          <div className="aspect-square w-7 animate-pulse rounded-md bg-slate-400 delay-150" />
          <div className="aspect-square w-7 animate-pulse rounded-md bg-slate-400 delay-300" />
          {count % 2 === 0 && (
            <div className="aspect-square w-7 animate-pulse rounded-md bg-slate-400 delay-450" />
          )}
        </div>
