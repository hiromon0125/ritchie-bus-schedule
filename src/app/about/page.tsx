...
async function Page() {
  return (
    <>
      <Header />
      <h3 id="about-ritchie-s-bus-schedule">
      ...
      <p>
        ...
        helping students at Rochester Institute of Technology (RIT) navigate the
        campus bus system more efficiently. If you&#39;ve ever found yourself
        frustrated with missing the bus or spending too much time navigating the
        RIT website to find bus schedules, this app is designed for you.
      </p>
      <p>
      ...
      <ul>
        <li>
          <strong>Unified Status Page:</strong> View the status of all RIT buses
          at a glance on a single page.
        </li>
        <li>
      ...
      <p>
        ...
        includes Next.js, React, and Tailwind for the frontend, tRPC for remote
        procedure calls, Drizzle ORM for database interactions, Vercel for API
        and hosting, and Supabase as the database. This modern stack ensures a
      ...
      <p>
        ...
        consultation of documentation. Additionally, a recent change in database
        subscription fees necessitated a migration, which temporarily set back
        development. However, through diligent effort and a commitment to
        overcoming obstacles, the team has made significant progress.
      </p>
      <p>
      ...
      <p>
        ...
        status tracking. Instead of relying on real-time data, the app uses the
        provided bus schedules to make educated guesses about bus locations.
        This approach ensures that the app remains functional and reliable, even
      ...
      <p>
        ...
        authentication, simplifying the authentication process and ensuring user
        data remains secure. Additionally, the app does not track user
        locations, reducing complexity and enhancing privacy.
      </p>
      <p>
      ...
      <p>
        ...
        more efficient for all students. Thank you for visiting, and we hope you
