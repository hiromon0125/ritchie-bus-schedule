    ...
    <div>
      ...
      <div className=" m-auto w-full max-w-screen-lg pb-12 opacity-80">
        ...
        <div className=" flex flex-col gap-4">
          ...
          <p>
            Thank you for choosing Ritchie’s Bus Schedule Application ("App").
          ...
          <ol className=" flex flex-col gap-2">
              ...
              <ol className=" flex flex-col gap-3 pl-3 pt-3">
                <li>
                  ...
                  <div className=" flex flex-col gap-2 pl-5">
                    ...
                    <p>
                      <b>Data Collected:</b> Clerk handles authentication
                      securely on our behalf and may collect information such as
                      your email address and unique identifiers associated with
                      your Google account if you choose to authenticate with
                      Google.
                    </p>
                  </div>
                </li>
                ...
                <li>
                  ...
                  <p className=" pl-5">
                    <b>Logs:</b> We collect limited debugging logs to
                    troubleshoot technical issues and improve App performance.
                    These logs may include anonymized data on how users interact
                    with the App but are not tied to personally identifiable
                    information.
                  </p>
                </li>
              </ol>
            ...
            <li>
              ...
              We do not share or sell any of your personal information with
              third parties for marketing purposes. However, we may share
              information with service providers, such as Clerk, solely to
              facilitate the services they provide for authentication and
              security purposes.
            </li>
            <li>
              <h2 className=" mb-3 mt-4 text-xl font-semibold">
              ...
              We are committed to securing your information. We implement a
              range of security measures, including encryption and regular
              security assessments, to ensure your data is protected against
            ...
            <li>
              ...
              Our App uses Clerk and Google as authentication providers to
              enhance security. By using our App and choosing Google or Clerk as
              your authentication method, you agree to the terms and privacy
              policies of these providers. We recommend reviewing{" "}
              <a
            ...
            <li>
              ...
              Access and Manage Your Data: You can update your account
              information and preferences by accessing your profile settings
              within the App. Delete Account: If you wish to delete your account
              and any associated data, please contact our support team, and we
              will facilitate the deletion process in compliance with applicable
              regulations.
            </li>
            <li>
              <h2 className=" mb-3 mt-4 text-xl font-semibold">
              ...
              in our practices or legal obligations. Any updates will be posted
