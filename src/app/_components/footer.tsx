        ...
        <div className=" bg-border-background/60 mx-auto h-(--mobile-bottom-nav-height) justify-center rounded-3xl p-3 shadow-md backdrop-blur-md">
          <div className=" top-0 m-auto flex h-full w-full max-w-(--breakpoint-lg) flex-row items-center gap-4">
            ...
            >
              <Link
                href="/buses"
                className=" bg-item-background flex h-full flex-1 flex-col items-center justify-center gap-1 rounded-lg border-[3px] border-white shadow-[0_4px_4px_0_var(--black-shadow-color),0_-1px_2px_0_var(--white-shadow-color)] transition-all hover:border-accent hover:shadow-md"
              >
...
function ServiceInfoBtn() {
  return (
    <Suspense
      fallback={
        <ServiceInfoButton className=" bg-item-background flex h-full flex-1 flex-col items-center justify-center rounded-lg border-[3px] border-white shadow-[0_4px_4px_0_var(--black-shadow-color),0_-1px_2px_0_var(--white-shadow-color)] transition-all hover:border-accent hover:shadow-md max-xs:hidden">
...
async function AlertNavigation() {
  ...
  return (
    <ServiceInfoButton className=" bg-item-background flex h-full flex-1 flex-col items-center justify-center gap-1 rounded-lg border-[3px] border-white shadow-[0_4px_4px_0_var(--black-shadow-color),0_-1px_2px_0_var(--white-shadow-color)] transition-all hover:border-accent hover:shadow-md max-xs:hidden">
      <LuClockAlert size={24} color="#0f172a" />
      <div className=" relative">
        <p>Alert</p>
        {count > 0 && (
          <div className=" absolute right-[-8px] top-[-5px] flex aspect-square h-4 flex-row items-center justify-center rounded-full bg-red-500 text-xs font-bold text-white">
            <p>{count}</p>
          </div>
        )}
      </div>
