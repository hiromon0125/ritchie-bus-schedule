...
export default function RouteMapOr({
  ...
  return (
    <>
      <div className="bg-item-background w-(--sm-max-w) overflow-hidden rounded-3xl border-4 border-gray-400 md:max-w-(--breakpoint-lg)">
        <div className=" flex flex-row items-center justify-between border-b-2 border-b-gray-400 px-4 py-3 md:max-w-(--breakpoint-lg)">
